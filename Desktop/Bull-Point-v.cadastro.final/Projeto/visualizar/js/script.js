...
function abrirModalEditar(index) {
    console.log("Abrindo modal para editar índice:", index);
    indexEditando = index;
...
function salvarEdicao() {
    console.log("Tentando salvar edição, índice:", indexEditando);

    if (indexEditando === null || indexEditando === undefined) {
